...
from w2v.rnn_model_w2v import TRNNConfig, TextRNN
from w2v.cnews_loader_w2v import word_to_vec, read_category, batch_iter, process_file, file_process_test
...
save_dir = '../checkpoints/w2v/textrnn'
...
def train():
    ...
    tensorboard_dir = '../tensorboard/w2v/textrnn'
