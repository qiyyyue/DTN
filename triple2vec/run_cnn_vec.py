...
from triple2vec.cnn_model_vec import TCNNConfig, TextCNN
from triple2vec.cnews_loader_vec import word_to_vec, read_category, batch_iter, process_file

base_dir = '../data/train_news/brexit_data'
...
def train():
    ...
    tensorboard_dir = '../tensorboard/w2v/textcnn'
